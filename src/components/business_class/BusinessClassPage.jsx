...
import { addBusinessClass } from "../../utils/businessClassSlice"
...
const BusinessClassPage = () => {
    ...
    const {isLoading, businessClass} = useSelector((store) => store.businessClass)
    const dispatch = useDispatch()

    const getBusinessClass = async() => {
        const res = await axios.get(BASE_URL+"/business-class")
        console.log(res.data)
        dispatch(addBusinessClass(res.data.businessClassCountries))
    }
