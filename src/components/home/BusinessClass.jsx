...
const BusinessClass = () => {
    ...
    <div className="flex justify-between  my-[30px] items-center">
        ...
        <Link to = '/BusinessClass'><span className="md:mr-[90px] lg:mr-[240px] xl:mr-[130px] md:block hidden text-[1.2rem] cursor-pointer font-bold text-blue-400 hover:text-blue-500 hover:transition-all hover:duration-300 hover:ease-in-out">View All <i className="fa-solid fa-chevron-right"></i></span> </Link>
    </div>
    <div className="grid md:grid-cols-2  lg:grid-cols-2 xl:grid-cols-3 md:mx-[80px] lg:mx-[90px] xl:mx-[120px] gap-[30px]">
        {businessClassCountries.map((data) => {
