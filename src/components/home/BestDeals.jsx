...
const BestDeals = () => {
    return  <section className="max-w-[1400px] mx-auto">
        <div className="md:flex justify-between  my-[30px] items-center  mt-[50px]">
            ...
            <Link to = '/BestDeals'><span className="md:block hidden md:mr-[90px] lg:mr-[240px] xl:mr-[130px]  text-[1.2rem] cursor-pointer font-bold text-blue-400 hover:text-blue-500 hover:transition-all hover:duration-300 hover:ease-in-out">View All <i class="fa-solid fa-chevron-right"></i></span></Link>
        </div>
        <div className="grid md:grid-cols-2  lg:grid-cols-2 xl:grid-cols-3 md:mx-[80px] lg:mx-[90px] xl:mx-[120px] gap-[30px]">
            {bestDealsCountries.map((data) => {
               ...
               return ( <div  key={id} className="pb-[18px] rounded-lg group overflow-hidden hover:shadow-md  bg-white w-[340px] md:w-[368px] border-[1px] border-gray-200 mb-[40px] mx-auto md:mx-[0px]">
