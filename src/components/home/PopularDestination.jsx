...
const PopularDestination = () => {
    ...
    <div className="flex flex-col items-center justify-center md:h-[720px] h-[680px]  mt-[0px] bg-cover bg-center bg-[url('https://images.unsplash.com/photo-1732951360671-ed85cf569e8b?fm=jpg&q=60&w=3000&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')]">  
        ...
        <h1 className="text-white font-bold md:text-[2.6rem] text-center text-[1.9rem] mb-[10px]" style={{ textShadow: '0 0 15px #000' }}>Explore the World With RivalTrip</h1>
       <Search/> 
    </div>
