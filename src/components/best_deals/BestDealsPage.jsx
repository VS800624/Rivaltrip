...
const BestDealsPage = () => {
    ...
    return <section className=" md:mt-[160px] max-w-[1400px] mx-auto">
        ...
        <h3 className="text-[1.67rem] text-gray-700 font-semibold ">Best Deals</h3>
        </div>
            <div className="md:flex justify-between  my-[30px] items-center  mt-[50px]">
                <h2 className="md:text-[2rem] text-[1.6rem] font-bold  md:ml-[110px] xl:ml-[150px] pl-[36px] md:pl-[0px] ">BEST DEALS </h2>
            </div>
            <div className="grid md:grid-cols-2  lg:grid-cols-2 xl:grid-cols-3 md:mx-[80px] lg:mx-[90px] xl:mx-[120px] gap-[30px]">
                {bestDealsCountriesPage.map((data) => {
                   const {countryName, city, discount, price, img, id} = data
                   return ( 
                            <div key={id} className="pb-[18px] rounded-lg group overflow-hidden hover:shadow-md  bg-white w-[340px] md:w-[368px] border-[1px] border-gray-200 mb-[40px] mx-auto md:mx-[0px]">
