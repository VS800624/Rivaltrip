...
const DestinationPage = () => {
    ...
    const getDestination = async() => {
        try{
            const res =  await axios.get("http://localhost:3000/api/popular-destinations")
   ...
   return <section className=" md:mt-[160px] mx-auto max-w-[1400px]">
      ...
      { destinations && <div className="grid sm:grid-cols-2  justify-content md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 md:mx-[80px] lg:mx-[100px]">
           {
               destinations.map((property) => {
                   const {countryName, city, img, _id, slug} = property
                   return ( 
                            <div key={_id} className="rounded-lg  bg-white md:w-[272px] w-[330px]  mx-auto lg:mx-[0px] md:border-[1px] md:border-gray-200 mb-[40px] group overflow-hidden hover:shadow-md">
