        ...
        <section className="md:mt-[160px] mx-auto max-w-[1400px]">
            ...
            <div className="flex flex-col-reverse mx-[30px] mb:mx-[40px] shrink items-center md:flex-row-reverse mt-[120px] gap-[20px] text-gray-500">
                ...
                <div className="md:w-[50%]">
                    <img
                        className="h-full w-full object-cover object-center rounded-[10px]"
                        src="https://images.unsplash.com/photo-1436491865332-7a61a109cc05?q=80&w=2348&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
